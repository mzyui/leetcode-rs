...
fn generate_problem_readmes(
    ...
    for (n, p) in problems.iter().enumerate() {
        ...
        let sufix = if filetype == FileType::Index { "" } else { ".md" };
        out.push_str(&render_pagination(problems, n, sufix));
...
fn generate_index_readme(
    ...
    out.push_str("![leetcode-rs banner](docs/assets/banner.png)\n\n");
